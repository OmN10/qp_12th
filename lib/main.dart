...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
        providers: [
          ChangeNotifierProvider(create: (_) => Jeemainscontrolle()),
          ChangeNotifierProvider(create: (_) => Jeeadvancedcontroller()),
          ChangeNotifierProvider(create: (_) => Mhcetcontroller()),
          ChangeNotifierProvider(create: (_) => neetContoller()),
        ],
        child: MaterialApp(
            title: 'Flutter Demo',
            theme: ThemeData(
